...
##############################################################################
# 3b) Speech-to-Text function
##############################################################################

def speech_to_text():
    """
    Captures audio from the microphone and attempts to transcribe it via
    Google Web Speech API using the 'speech_recognition' library.
    """
    ...
    with microphone as source:
        ...
        print("Speak a command to find a tool in the workshop...")
...
##############################################################################
# 4) Extract Tools from the spaCy Doc
##############################################################################
